...
})(["font-size:3rem;margin:20px;position:relative;height:10rem;z-index:2;transform:skew(-10deg);a{margin-top:2rem;padding:3rem 1rem;background:rgb(63,94,251);background:radial-gradient(circle,rgba(63,94,251,1) 0%,rgba(252,70,107,1) 100%);color:", ";text-transform:uppercase;text-decoration:none;border-radius:50%;}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
...
//# sourceMappingURL=_app.js.463ac2b9a74c8dc69e9a.hot-update.js.map