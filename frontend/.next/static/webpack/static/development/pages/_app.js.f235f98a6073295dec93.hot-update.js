...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;transform:skew(-10deg);a{padding:0.5rem 1rem;background:rgb(131,58,180);background:linear-gradient(90deg,rgba(131,58,180,1) 0%,rgba(253,29,29,1) 50%,rgba(252,176,69,1) 100%);color:", ";text-transform:uppercase;text-decoration:none;border-radius:42%;}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
...
//# sourceMappingURL=_app.js.f235f98a6073295dec93.hot-update.js.map