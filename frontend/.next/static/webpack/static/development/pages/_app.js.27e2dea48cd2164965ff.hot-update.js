...
})(["font-size:3rem;margin-left:2rem;font-weight:500;position:relative;z-index:2;transform:skew(-10deg);a{padding:1rem 1rem;font-weight:500;background:rgb(218,199,231);background:radial-gradient(circle,rgba(218,199,231,1) 0%,rgba(227,155,155,1) 50%,rgba(242,211,167,1) 100%);color:", ";text-decoration:none;border-radius:50%;}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
...
//# sourceMappingURL=_app.js.27e2dea48cd2164965ff.hot-update.js.map