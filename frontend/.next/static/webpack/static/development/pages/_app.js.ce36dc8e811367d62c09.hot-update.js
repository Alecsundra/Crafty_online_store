...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;transform:skew(-10deg);a{padding:0.5rem 1rem;background:rgb(63,94,251);background:radial-gradient(circle,rgba(63,94,251,1) 0%,rgba(252,70,107,1) 100%);color:", ";text-transform:uppercase;text-decoration:none;border-radius:42%;}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
...
//# sourceMappingURL=_app.js.ce36dc8e811367d62c09.hot-update.js.map