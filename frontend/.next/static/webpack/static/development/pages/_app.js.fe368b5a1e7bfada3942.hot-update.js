...
})(["font-size:3rem;margin-left:2rem;position:relative;height:10rem;z-index:2;transform:skew(-10deg);a{padding:2rem 2rem;background:rgb(63,94,251);background:radial-gradient(circle,rgba(63,94,251,1) 0%,rgba(252,70,107,1) 100%);color:", ";text-transform:uppercase;text-decoration:none;border-radius:50%;}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
...
//# sourceMappingURL=_app.js.fe368b5a1e7bfada3942.hot-update.js.map